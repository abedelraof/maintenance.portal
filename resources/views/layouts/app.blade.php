<!DOCTYPE html>
<!-- saved from url=(0074) -->
<html lang="en" direction="rtl" style="direction: rtl;"><!--begin::Head-->
<head>
    ...
    <!--          href="https://preview.keenthemes.com/keen/theme/demo3/dist/assets/media/logos/favicon.ico">-->
    ...
    <style>
        ...
        .nav.nav-pills .nav-link.active, .nav.nav-pills .show > .nav-link {
            ...
            /* padding-top: 20px; */
            /* padding-bottom: 20px; */
            background: linear-gradient(38deg, #378267, #61bc9b);
        }

        .nav.nav-pills .nav-link.active .nav-text, .nav.nav-pills .show > .nav-link .nav-text {
            font-weight: bold;
        }
    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                                           ...
                                           class="navi-link">
													<span class="navi-icon">
														<span class="svg-icon svg-icon-md svg-icon-primary">
															<!--begin::Svg Icon | path:/keen/theme/demo3/dist/assets/media/svg/icons/Communication/Add-user.svg-->
															<svg xmlns="http://www.w3.org/2000/svg"
                                            ...
                                            <span class="navi-text">تسجيل خروج</span>
                                        </a>
                                    </li>
                                </ul>
                                <!--end::Navigation-->
            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <!--                                <h4 class="text-dark font-weight-bold my-1 mr-5">Bootstrap Navs</h4>-->
                <!--                                &lt;!&ndash;end::Page Title&ndash;&gt;-->
                <!--                                &lt;!&ndash;begin::Breadcrumb&ndash;&gt;-->
                <!--                                <ul class="breadcrumb breadcrumb-transparent breadcrumb-dot font-weight-bold p-0 my-2 font-size-sm">-->
                <!--                                    <li class="breadcrumb-item">-->
                <!--                                        <a href=""-->
                <!--                                           class="text-dark-50">Features</a>-->
                <!--                                    </li>-->
                <!--                                    <li class="breadcrumb-item">-->
                <!--                                        <a href=""-->
                <!--                                           class="text-dark-50">Bootstrap</a>-->
                <!--                                    </li>-->
                <!--                                    <li class="breadcrumb-item">-->
                <!--                                        <a href=""-->
                <!--                                           class="text-dark-50">Navs</a>-->
                <!--                                    </li>-->
                <!--                                </ul>-->
